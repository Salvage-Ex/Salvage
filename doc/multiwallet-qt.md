...
In order to support loading of multiple wallets in securecloud-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is securecloud.cpp.
...
Changes to securecloud.cpp
----------------------
securecloud.cpp is the entry point into securecloud-qt, and as such, will require some minor modifications to provide hooks for
