...
In order to support loading of multiple wallets in salvage-qt, a few changes in the UI architecture will be needed.
...
----------------------
salvage.cpp is the entry point into salvage-qt, and as such, will require some minor modifications to provide hooks for
