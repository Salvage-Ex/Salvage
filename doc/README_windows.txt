...
Intro
-----
Salvage (SVG) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Salvage utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run salvage-qt.exe.

Salvage Core is the original Salvage client and it builds the backbone of the network.
However, it downloads and stores the entire history of Salvage transactions;
