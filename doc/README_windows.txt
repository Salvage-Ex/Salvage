...
Intro
-----
SecureCloud (SCN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. SecureCloud utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run securecloud-qt.exe.

SecureCloud Core is the original SecureCloud client and it builds the backbone of the network.
However, it downloads and stores the entire history of SecureCloud transactions;
