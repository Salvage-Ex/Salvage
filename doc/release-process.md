...
- Detached signatures will then be committed to the [salvage-detached-sigs](https://github.com/Salvage-Ex/Salvage-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the https://www.svg.network/ server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Salvage-Ex/Salvage/releases/new) with a link to the archived release notes.
