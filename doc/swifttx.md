...
This mechanism has been integrated into Bitcore-Node-SecureCloud which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/securecloud/insight-api-securecloud#web-socket-api](https://github.com/securecloud/insight-api-securecloud#web-socket-api)
* API: [https://github.com/securecloud/insight-api-securecloud#swifttx-transactions](https://github.com/securecloud/insight-api-securecloud#swifttx-transactions)
...
By default, the SecureCloud Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SecureCloud Core daemon:
