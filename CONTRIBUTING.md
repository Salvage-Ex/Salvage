Contributing to SecureCloud Core
==================================

The SecureCloud Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SecureCloud Core project, and is not to be
confused with overall SecureCloud Network Protocol consensus changes.

Whether a pull request is merged into SecureCloud Core rests with the project merge
...
Patches that change SecureCloud consensus rules are considerably more involved than
...
Where a patch set proposes to change the SecureCloud consensus, it must have been
...
The project leader is the release manager for each SecureCloud Core release.
