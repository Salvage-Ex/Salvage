Contributing to Salvage Core
==================================

The Salvage Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Salvage Core project, and is not to be
confused with overall Salvage Network Protocol consensus changes.

Whether a pull request is merged into Salvage Core rests with the project merge
...
Patches that change Salvage consensus rules are considerably more involved than
...
Where a patch set proposes to change the Salvage consensus, it must have been
...
The project leader is the release manager for each Salvage Core release.
