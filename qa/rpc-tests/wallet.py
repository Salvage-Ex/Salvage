...
#   c) node1 mines 32 blocks, so now node 0 has 500000SVG, node 1 has 4250SVG, node2 has none.
#   d) node0 sends 601 SVG to node2, in two transactions (301 SVG, then 300 SVG).
