...
#   c) node1 mines 32 blocks, so now node 0 has 500000SCN, node 1 has 4250SCN, node2 has none.
#   d) node0 sends 601 SCN to node2, in two transactions (301 SCN, then 300 SCN).
