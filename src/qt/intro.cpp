...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SecureCloud Core"),
     ...
     * override -datadir in the securecloud.conf file in the default data directory
     * (to be consistent with securecloudd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
