                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Salvage Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SVG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and salvage: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Salvage Core"), this);
    aboutAction->setStatusTip(tr("Show information about Salvage Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Salvage"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SVG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SVG addresses"));
    ...
    openAction->setStatusTip(tr("Open a salvage: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Salvage Core help message to get a list with possible Salvage command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Salvage Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Salvage network", "", count));
}
...
{
    QString strTitle = tr("Salvage Core"); // default title
