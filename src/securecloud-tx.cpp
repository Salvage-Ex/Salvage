...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SecureCloud Core securecloud-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  securecloud-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded securecloud transaction") + "\n" +
                               "  securecloud-tx [options] -create [commands]   " + _("Create hex-encoded securecloud transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded securecloud transaction
